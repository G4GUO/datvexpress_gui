...
void DVBS2::modulator_configuration(void)
{
        ...
        r1 = m;
	// BPSK
        m_bpsk[0][0].re = (short)((r0*cos(M_PI/4.0))*CP);
        m_bpsk[0][0].im = (short)((r0*sin(M_PI/4.0))*CP);
        m_bpsk[0][1].re = (short)((r0*cos(5.0*M_PI/4.0))*CP);
        m_bpsk[0][1].im = (short)((r0*sin(5.0*M_PI/4.0))*CP);
        m_bpsk[1][0].re = (short)((r0*cos(5.0*M_PI/4.0))*CP);
        m_bpsk[1][0].im = (short)((r0*sin(M_PI/4.0))*CP);
        m_bpsk[1][1].re = (short)((r0*cos(M_PI/4.0))*CP);
        m_bpsk[1][1].im = (short)((r0*sin(5.0*M_PI/4.0))*CP);
